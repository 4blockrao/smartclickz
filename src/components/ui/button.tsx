  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline: "border border-primary bg-transparent text-primary hover:bg-primary/5 hover:shadow-sm",
        secondary: "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/90",
        ghost: "hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        success: "bg-accent-green text-white shadow-sm hover:bg-accent-green/90 hover:shadow-md",
        warning: "bg-warning text-warning-foreground shadow-sm hover:bg-warning/90",
      },
      size: {
        default: "h-11 px-5 py-3 min-w-[2.75rem]", // 44px height for touch
        sm: "h-9 rounded-lg px-3 text-xs min-w-[2.25rem]",
        lg: "h-12 rounded-xl px-6 text-base min-w-[3rem]",
        xl: "h-14 rounded-xl px-8 text-lg min-w-[3.5rem]",
        icon: "h-11 w-11",
